...
def render_first_step_payment_pro_page(request):
    error = ""
    ...
    return render(request, "first_step_payment_pro.html", context = {"error" : error})




def render_second_step_payment_pro_page(request):
    error = ""
    user_now = request.user
    ...
    return render(request, "second_step_payment_pro.html", context = {"error" : error})
